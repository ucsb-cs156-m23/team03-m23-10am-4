...
describe("ArticlesEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(explanationField).toHaveValue("This is article 1");
            expect(emailField).toHaveValue("email1@gmail.com");
            expect(dateAddedField).toHaveValue("2023-03-26T12:00");
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(emailField, { target: { value: "email2@gmail.com" } })
            fireEvent.change(dateAddedField, { target: { value: "2023-03-27T12:00" } })

            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("Article Updated - id: 17 name: Article 2");
