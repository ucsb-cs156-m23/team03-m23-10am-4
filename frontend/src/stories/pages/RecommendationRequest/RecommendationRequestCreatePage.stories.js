...
export default {
    title: 'pages/RecomendationRequest/RecomendationRequestCreatePage',
    component: RecomendationRequestCreatePage
};

const Template = () => <RecomendationRequestCreatePage storybook={true} />;
