...
export default {
    title: 'pages/RecomendationRequest/RecomendationRequestIndexPage',
    component: RecomendationRequestIndexPage
};

const Template = () => <RecomendationRequestIndexPage storybook={true}/>;
